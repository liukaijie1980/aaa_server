...
(
PARTITION p20250121 VALUES LESS THAN (739638),
PARTITION p20250122 VALUES LESS THAN (739639),
PARTITION p20250123 VALUES LESS THAN (739640),
PARTITION p20250124 VALUES LESS THAN (739641),
PARTITION p20250125 VALUES LESS THAN (739642),
PARTITION p20250126 VALUES LESS THAN (739643),
PARTITION p20250127 VALUES LESS THAN (739644),
PARTITION p20250128 VALUES LESS THAN (739645),
...
--
-- Create index `IDX_radpostauth_authdate` on table `radpostauth`
--
ALTER TABLE radpostauth
ADD INDEX IDX_radpostauth_authdate (authdate);
...
BEGIN
  ...
  DECLARE best_reversal tinyint(1) DEFAULT NULL;
  DECLARE max_mask int DEFAULT 0;
...
read_loop:
  LOOP
    ...
    IF ip = '*'
      AND max_mask <= 0 THEN
      SET max_mask = 0;
      SET best_reversal = value_reversal;

    ELSEIF ip = nasip
      AND max_mask < 32 THEN
      SET max_mask = 32;
      SET best_reversal = value_reversal;
    ...
    ELSEIF INSTR(ip, '/') > 0 THEN
      ...
      IF (INET_ATON(nasip) >> mask_offset << mask_offset) = (INET_ATON(net) >> mask_offset << mask_offset)
        AND mask > max_mask THEN
        SET max_mask = mask;
        SET best_reversal = value_reversal;
      END IF;
...
CREATE USER 'mariadb.sys'@'localhost' IDENTIFIED WITH mysql_native_password;



CREATE USER 'monitor_user'@'%' IDENTIFIED WITH mysql_native_password;
GRANT USAGE ON *.* TO 'monitor_user'@'%'
WITH GRANT OPTION;
SET PASSWORD FOR 'monitor_user'@'%' = '*6BB4837EB74329105EE4568DDA7DC67ED2CA2AD9';
GRANT ALTER, ALTER ROUTINE, CREATE, CREATE ROUTINE, CREATE TABLESPACE, CREATE TEMPORARY TABLES, CREATE USER, CREATE VIEW, DELETE, DELETE HISTORY, DROP, EVENT, EXECUTE, FILE, INDEX, INSERT, LOCK TABLES, PROCESS, REFERENCES, RELOAD, REPLICATION CLIENT, REPLICATION SLAVE, SELECT, SHOW DATABASES, SHOW VIEW, SHUTDOWN, SUPER, TRIGGER, UPDATE ON *.* TO 'monitor_user'@'%';



CREATE USER 'mysql.session'@'localhost' IDENTIFIED WITH mysql_native_password;
GRANT SELECT ON performance_schema.* TO 'mysql.session'@'localhost';



CREATE USER 'mysql.sys'@'localhost' IDENTIFIED WITH mysql_native_password;
GRANT TRIGGER ON sys.* TO 'mysql.sys'@'localhost';



CREATE USER 'repl'@'%' IDENTIFIED WITH mysql_native_password;
SET PASSWORD FOR 'repl'@'%' = '*6BB4837EB74329105EE4568DDA7DC67ED2CA2AD9';
...
WITH GRANT OPTION;
SET PASSWORD FOR 'root'@'%' = '*6BB4837EB74329105EE4568DDA7DC67ED2CA2AD9';
GRANT ALTER, ALTER ROUTINE, CREATE, CREATE ROUTINE, CREATE TABLESPACE, CREATE TEMPORARY TABLES, CREATE USER, CREATE VIEW, DELETE, DELETE HISTORY, DROP, EVENT, EXECUTE, FILE, INDEX, INSERT, LOCK TABLES, PROCESS, REFERENCES, RELOAD, REPLICATION CLIENT, REPLICATION SLAVE, SELECT, SHOW DATABASES, SHOW VIEW, SHUTDOWN, SUPER, TRIGGER, UPDATE ON *.* TO 'root'@'%';
...
WITH GRANT OPTION;
SET PASSWORD FOR 'root'@'localhost' = '*57237BB49761F29AB9724BA084E811D70C12393D';
GRANT ALTER, ALTER ROUTINE, CREATE, CREATE ROUTINE, CREATE TABLESPACE, CREATE TEMPORARY TABLES, CREATE USER, CREATE VIEW, DELETE, DELETE HISTORY, DROP, EVENT, EXECUTE, FILE, INDEX, INSERT, LOCK TABLES, PROCESS, REFERENCES, RELOAD, REPLICATION CLIENT, REPLICATION SLAVE, SELECT, SHOW DATABASES, SHOW VIEW, SHUTDOWN, SUPER, TRIGGER, UPDATE ON *.* TO 'root'@'localhost';



CREATE USER 'service_user'@'%' IDENTIFIED WITH mysql_native_password;
GRANT USAGE ON *.* TO 'service_user'@'%'
WITH GRANT OPTION;
SET PASSWORD FOR 'service_user'@'%' = '*6BB4837EB74329105EE4568DDA7DC67ED2CA2AD9';
GRANT ALTER, ALTER ROUTINE, CREATE, CREATE ROUTINE, CREATE TABLESPACE, CREATE TEMPORARY TABLES, CREATE USER, CREATE VIEW, DELETE, DELETE HISTORY, DROP, EVENT, EXECUTE, FILE, INDEX, INSERT, LOCK TABLES, PROCESS, REFERENCES, RELOAD, REPLICATION CLIENT, REPLICATION SLAVE, SELECT, SHOW DATABASES, SHOW VIEW, SHUTDOWN, SUPER, TRIGGER, UPDATE ON *.* TO 'service_user'@'%';
